 ...
 *
 * Timestamps are TEXT holding ISO-8601, not timestamptz. That is what the spec
 * specifies, and ISO-8601 sorts and compares lexicographically, so every
 * range query works unchanged - which keeps the diff from the original SQLite
 * schema down to placeholder syntax.
 */
